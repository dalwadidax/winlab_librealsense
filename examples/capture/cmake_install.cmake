# Install script for directory: /root/librealsense/examples/capture
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/root/librealsense/examples/capture/rs-capture")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/rs-capture" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/rs-capture")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/rs-capture"
